...
public class SendWechatForm extends AbstractStandardForm<SendWechatData, SendWechatPage>
{
	...
	protected SendWechatData data;

	private RecentQueue<String> recentSearchTermsQueue;

	public SendWechatForm(final SendWechatPage parentPage)
	{
		super(parentPage);
		data = new SendWechatData();
	}
	...
	{
		super.init();
		FieldsetPanel fs = gridBuilder.newFieldset(getString("address.sendWechaMsg.to"));
