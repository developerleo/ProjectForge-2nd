...
public class SendWechatPage extends AbstractStandardFormPage
{
	...
	private static final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(SendWechatPage.class);
	...
	private SendWechatForm form;

	String result;

	@SuppressWarnings("serial")
	public SendWechatPage(final PageParameters parameters)
	{
		super(parameters);
		form = new SendWechatForm(this);
		body.add(form);
	...
	protected void send()
	{
		...
		//		}
		log.info("Send we chat message called, but not implemented.");
	}
	...
	private SendWechatData getData()
	{
		return form.data;
	}
